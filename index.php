...
$dbuser = "jonilar"; // Nombre de usuario
$dbpass = "jonibismuler54199"; // Contraseña
...
{?>
  <tr class="one_third">
    <td><div style="width:33%" class="box soft-embossed"><?=$row['nombre']?>
   &nbsp; <a href="megusta.php?voto=positivo&id=<?=$row['id']?>"><img src="/ranking/gusta.jpg" width="95" height="50"></a>&nbsp;&nbsp;&nbsp; <a href="megusta.php?voto=negativo&id=<?=$row['id']?>"><img src="/ranking/nogusta.jpg" width="95" height="50"></a><br><font face="Lato, bold" color="#005EFF" size="7"> <?=$row['megusta']?> votos</font></div>
<?php	
}	
?>
</body>
